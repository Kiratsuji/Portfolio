  ...
  return (
      ...
      <div
          ...
          <main className="grow max-w-7xl w-full mx-auto px-4 py-8 flex flex-col gap-12">
              ...
              {/* SECTON 1: Hero / Introdução */}
              <section id="home" className="flex flex-col items-center justify-center text-center py-32 bg-primary text-text-primary rounded-2xl border-2 border-border">
