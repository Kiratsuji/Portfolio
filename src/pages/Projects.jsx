            ...
            <div className="flex gap-3 px-5 pb-5">
                {project.buttons.primary && (
                    <a
                        ...
                        target="_blank"
                        className="flex-1 text-center bg-blue-500 hover:bg-blue-600 text-white text-sm font-semibold py-2 rounded-lg transition-colors">
                        {project.buttons.primary.label}
                    </a>
                )}
                {project.buttons.code && (
                    <a
                        href={project.buttons.code.url}
                        target="_blank"
                        className="flex-1 text-center border border-gray-600 hover:border-blue-400 text-gray-300 hover:text-blue-400 text-sm font-semibold py-2 rounded-lg transition-colors">
                        {project.buttons.code.label}
                    </a>
                )}
                {project.buttons.wiki && (
                    <a
                        href={project.buttons.wiki.url}
                        className="flex-1 text-center border border-gray-600 hover:border-purple-400 text-gray-300 hover:text-purple-400 text-sm font-semibold py-2 rounded-lg transition-colors">
                        {project.buttons.wiki.label}
                    </a>
                )}
            </div>
        </div>
...
// ── Sistema de filtros ───────────────────────────────────────
const categorias = ["Todos", "Jogos & Mods", "Web & Mobile"];
...
export default function ProjectsPage() {
    ...
    return (
        <div
            ...
            className="flex flex-col min-h-screen bg-black text-gray-800 bg-fixed bg-center bg-no-repeat bg-auto"
        >
            <header>
                <Navbar />
            </header>
